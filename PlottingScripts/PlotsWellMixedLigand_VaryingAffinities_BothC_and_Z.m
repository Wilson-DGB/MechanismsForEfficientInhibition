...
Str1a = '../WellMixedLigandData/WellMixedLigandModel-CaseNeither-k4=10.0-k5=100.0-km5=';
Str3 = '-CD80Number=';
Str5 = '-PDL1Number=';
...
for km5s=1:length(Km5Span)
    ...
    CD80PDL1 = zeros(1,length(PDL1Span));
    for z=1:10
...
%         pause
        ...
        %         pause
        %         hold on
        CD28Ph(z) = mean(T(10000:end,1));
        CD80PDL1(z) = mean(T(10000:end,2));
    ...
    hold on
    figure(2)
    semilogx(PDL1Span,CD80PDL1/min(100,PDL1Span(z)),'*-','MarkerSize',10)
    hold on
end

%% Run the case with no ligand binding to each other

Str1a = '../WellMixedLigandData/WellMixedLigandModel-CaseNeither-k4=10.0-k5=0.0-km5=';
Str3 = '-CD80Number=';
Str5 = '-PDL1Number=';
Str7a = '-MolecularReach=15-N=64-PD1=';
Str9 = '-CD28=10-tf=';
...
for km5s=1:length(Km5Span)
    ...
    hold on
    figure(2)
    semilogx(PDL1Span,CD80PDL1/min(100,PDL1Span(z)),'dk-','MarkerSize',10)
    hold on
end
...
legend('km5 = 0.001','km5 = 0.01','km5 = 0.1','km5 = 1.0','km5 = 10.0','km5 = 100.0','No dimerisation')
xlabel('Number of PDL1 ligand')
ylabel('fraction of bound ligand')
title('Well mixed ligand dimerisation: case neither')
