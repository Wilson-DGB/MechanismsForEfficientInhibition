...
NPD1 = 1000 # number of PD1 receptors
...
k5_star = 100.0 # phosphorylation rate
    ...
    # saving parameters
    dosave      = true
    outfname    = "/home/daniel/Documents/MechanismsForEfficientInhibition/ModellingLigandInteractions/DoseResponseCurves/AllPathways/Ligand_Dimerisation/data/WellMixedLigandModel-CaseBoth-k5=$(k5_star)-CD80Number=$(NCD80)-PDL1Number=$(PDL1Span[z])-MolecularReach=$(MR)-N=$(N)-PD1=$(NPD1)-CD28=$(NCD28)-tf=$(tf)-dt=$(dt)-nsims=$(Nsim).csv"
    ...
    function RunSolver(Nsim,tf,dt,NA,NB,NC,ND,NE,NCD80,N,wrappeddist,k5_star)
        ...
        for nsim=1:Nsim
            ...
            Propensities[4:3+NT] = k1*(current_CD80+current_CD80_PDL1)*(ParticleType .== 1) + (k2+km1)*(ParticleType .== 2) + (km2+km1)*(ParticleType .== 3) + k3*(current_PDL1+current_CD80_PDL1)*(ParticleType .== 4) + km3*(ParticleType .== 5)
